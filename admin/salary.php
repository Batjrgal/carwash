            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th><b>Нийт цалин</b></th>
                  <th><b>Үндсэн цалин(<?php echo htmlspecialchars($currentPercentage); ?>%)</b></th>
                  <th><b>Огноо</b></th>
                  <!-- <th>Actions</th> -->
                </tr>
              </thead>
        ...
        <div class="top-sales box">
          ...
          <div class="add-service-form">
            ...
            <form action="update_salary_percentage.php" method="POST">
              ...
              <input type="text" name="percentage" min="0" max="99" placeholder="0-99"
                value="<?php echo htmlspecialchars($currentPercentage); ?>" maxlength="2" required>
