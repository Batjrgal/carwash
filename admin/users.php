    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        ...
        <i class='fa-solid fa-pen-to-square'></i>
                  ...
                  echo "<tr><td colspan='7'>Хэрэглэгч байхгүй</td></tr>";
                }
                ?>
              </tbody>
            </table>
          ...
          <div class="modal-content">
            ...
            <form id="editServiceForm" action="update_user.php" method="POST">
              ...
              <input type="password" name="password" id="editPassword"
                placeholder="Нууц үгийг хадгалахын тулд хоосон орхино уу">
        ...
        <div class="top-sales box">
          ...
          <div class="add-service-form">
            <form action="add_user.php" method="POST">
              ...
              <input type="text" name="full_name" placeholder="Овог, нэр оруулна уу (А. Болд)" id="fullName" required>
