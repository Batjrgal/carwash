  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Үйлчилгээ</span>
      </div>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <button><a href='delete_service.php?id=" . $row['id'] . "' onclick='return confirm(\"Та устгахдаа итгэлтэй байна уу?\")' class='delete-btn'><i class='fa-solid fa-trash'></i></a></button>
                    </td>";
